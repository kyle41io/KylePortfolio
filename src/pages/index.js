    ...
    <>
      ...
      <main className='flex items-center text-dark dark:text-light w-full min-h-screen'>
        <Layout className='pt-0 md:p-16 sm:pt-8'>
          <div className='flex md:flex-col items-center justify-between w-ful'>
            <div className='w-5/12 md:w-3/4'> 
              <Image src={ProfilePic} alt='Kyle Nguyen' className='w-full h-auto'
              priority sizes="(max-width:768px) 100vw, (max-width:1200px) 50vw, 50vw"/>
            </div>
            <div className='w-1/2 md:w-3/4 md:pt-8 md:text-center flex flex-col items-center self-center'>
