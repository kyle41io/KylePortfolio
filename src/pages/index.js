          ...
          <div className="flex md:flex-col items-center justify-between w-ful">
            ...
            <div className="w-1/2 md:w-3/4 md:pt-8 md:text-center flex flex-col items-center self-center">
              ...
              <div className="flex items-center self-start mt-2 md:self-center">
                ...
                <MotionLink
                  href="mailto:vankien41hust@gmail.com"
                  target={"_blank"}
                  className="p-1 px-3 ml-4 text-lg  font-medium capitalize text-light dark:text-dark rounded-2xl bg-dark dark:bg-light hover:underline"
                  whileTap={{ scale: 0.9 }}
                  whileHover={{ y: -3 }}
                >
                  Contact
