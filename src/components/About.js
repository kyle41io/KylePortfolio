...
const About = () => {
  return (
    <div id='aboutme' className='flex w-full felx-col items-center justify-center'>
      <Layout className='pt-16'>
        ...
        <div className='grid w-full grid-cols-8 gap-16 '>
          <div className='col-span-3 flex flex-col items-start justify-start'>
            ...
            <p className='font-medium'>- I am committed to doing my best in every project I work on, no matter how big or small. I approach each task with a sense of humility and a willingness to learn from others. I know that there is always room for improvement, and I am open to constructive feedback that can help me grow as a web developer.
            </p>
          ...
          <div className='col-span-2 flex flex-col  items-end justify-between'>
            <div className='flex flex-col items-end justify-center'>
              ...
              <h2 className='text-xl font-medium text-dark/75'>Satisfied Clients</h2>
            </div>
            <div className='flex flex-col items-end justify-center'>
              <span className='inline-block text-7xl font-bold'>
            ...
            <div className='flex flex-col items-end justify-center'>
              ...
              <h2 className='text-xl font-medium text-dark/75'>Year Of Experience</h2>
            </div>
          </div>
        </div>
        <Skills />
