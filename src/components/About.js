      ...
      <Layout className='pt-16'>
        ...
        <div className='grid w-full grid-cols-8 gap-16 '>
          <div className='col-span-3 flex flex-col items-start justify-start'>
            ...
            <p className='font-medium text-dark dark:text-light'>- Hi, I&#39;m Kyle Nguyen, a fresher web developer. While I don&#39;t have a lot of experience yet, I am always eager to learn and grow in my field. I have worked on a few projects and have enjoyed the challenges that come with them.</p>
            <p className='font-medium text-dark dark:text-light my-4'>
            ...
            <p className='font-medium text-dark dark:text-light'>- I am committed to doing my best in every project I work on, no matter how big or small. I approach each task with a sense of humility and a willingness to learn from others. I know that there is always room for improvement, and I am open to constructive feedback that can help me grow as a web developer.
            </p>
          ...
          <div className='col-span-2 flex flex-col  items-end justify-between'>
            <div className='flex flex-col items-end justify-center'>
              ...
              <h2 className='text-xl font-medium text-dark/75 dark:text-light/90'>Satisfied Clients</h2>
            </div>
            <div className='flex flex-col items-end justify-center'>
              <span className='inline-block text-7xl font-bold text-dark dark:text-light'>
              <AnimatedNumbers  value={10}/>+</span>
              <h2 className='text-xl font-medium text-dark/75 dark:text-light/90'>Projects Completed</h2>
            </div>
            <div className='flex flex-col items-end justify-center'>
              <span className='inline-block text-7xl font-bold text-dark dark:text-light'>
              <AnimatedNumbers  value={1}/>+</span>
              <h2 className='text-xl font-medium text-dark/75 dark:text-light/90'>Year Of Experience</h2>
            </div>
          </div>
        </div>
        <Skills />
