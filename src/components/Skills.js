...
const Skill = ({name, x, y}) => {
  ...
  return(
    <motion.div className='flex items-center justify-center rounded-full font-semibold bg-dark dark:bg-light text-light dark:text-dark shadow-dark cursor-pointer absolute py-3 px-6 md:bg-transparent md:dark:bg-transparent md:text-dark md:dark:text-light md:text-sm' whileHover={{scale:1.1}} 
...
const Skills = () => {
  return (
    <>
      <h2 className=' font-bold text-8xl md:text-5xl mt-64 w-full text-center text-dark/90 dark:text-light'>Skills</h2>
      <div className='w-full h-screen lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark lg:bg-circularLightLg
